...
const ZONE_ACCENT: Record<string, { color: string; bg: string; dept: string }> = {
  ...
  NVL:  { color: "#f59e0b", bg: "rgba(245,158,11,0.08)",   dept: "Normandie / Centre Val de Loire — 14·18·27·28·36·41·45·50·61·76" },
  BPL:  { color: "#f97316", bg: "rgba(249,115,22,0.08)",   dept: "Bretagne / Pays de la Loire — 22·29·35·37·44·49·53·56·72·85" },
  ...
  PACA: { color: "#f472b6", bg: "rgba(244,114,182,0.08)",  dept: "PACA / Corse — 04·05·06·13·2A·2B·83" },
  ARA:  { color: "#fb923c", bg: "rgba(251,146,60,0.08)",   dept: "Auvergne-Rhône-Alpes — 03·07·15·26·38·42·43·63·69" },
  BFC:  { color: "#818cf8", bg: "rgba(129,140,248,0.08)",  dept: "Bourgogne-Franche-Comté — 01·21·25·39·58·70·71·73·74·89·90" },
  GES:  { color: "#34d399", bg: "rgba(52,211,153,0.08)",   dept: "Grand Est — 10·51·52·54·55·57·67·68·88" },
  IDFE: { color: "#e879f9", bg: "rgba(232,121,249,0.08)",  dept: "Île-de-France Est — 75·77·91·94" },
  IDFO: { color: "#60a5fa", bg: "rgba(96,165,250,0.08)",   dept: "Île-de-France Ouest — 78·92·93·95" },
};
