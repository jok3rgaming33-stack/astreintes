/**
 * Seed script — GES (Grand Est)
 * Run: node --env-file-if-exists=/vercel/share/.env.project scripts/seed-ges.mjs
 *
 * Remplir le tableau RESOURCES avec les données des ressources GES.
...
// Purge existing GES resources before reinserting
