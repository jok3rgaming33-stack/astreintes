/**
 * Seed script — BFC (Bourgogne - Franche-Comté)
 * Run: node --env-file-if-exists=/vercel/share/.env.project scripts/seed-bfc.mjs
 *
 * Remplir le tableau RESOURCES avec les données des ressources BFC.
...
// Purge existing BFC resources before reinserting
