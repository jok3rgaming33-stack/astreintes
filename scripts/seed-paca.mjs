/**
 * Seed script — PACA (Provence - Alpes - Côte d'Azur - Corse)
 * Run: node --env-file-if-exists=/vercel/share/.env.project scripts/seed-paca.mjs
 *
 * Remplir le tableau RESOURCES avec les données des ressources PACA.
...
// Purge existing PACA resources before reinserting
