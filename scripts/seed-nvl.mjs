/**
 * Seed script — NVL (Normandie - Centre Val de Loire)
 * Run: node --env-file-if-exists=/vercel/share/.env.project scripts/seed-nvl.mjs
 *
 * Remplir le tableau RESOURCES avec les données des ressources NVL.
...
// Purge existing NVL resources before reinserting
