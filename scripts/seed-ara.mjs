/**
 * Seed script — ARA (Auvergne - Rhône-Alpes)
 * Run: node --env-file-if-exists=/vercel/share/.env.project scripts/seed-ara.mjs
 *
 * Remplir le tableau RESOURCES avec les données des ressources ARA.
...
// Purge existing ARA resources before reinserting
