/**
 * Seed script — OCC (Occitanie)
 * Run: node --env-file-if-exists=/vercel/share/.env.project scripts/seed-occ.mjs
 *
 * Remplir le tableau RESOURCES avec les données des ressources OCC.
...
// Purge existing OCC resources before reinserting
