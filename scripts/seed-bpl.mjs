/**
 * Seed script — BPL (Bretagne - Pays de la Loire)
 * Run: node --env-file-if-exists=/vercel/share/.env.project scripts/seed-bpl.mjs
 *
 * Remplir le tableau RESOURCES avec les données des ressources BPL.
...
// Purge existing BPL resources before reinserting
