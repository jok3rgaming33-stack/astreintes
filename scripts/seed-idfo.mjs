/**
 * Seed script — IDFO (Île-de-France Ouest)
 * Run: node --env-file-if-exists=/vercel/share/.env.project scripts/seed-idfo.mjs
 *
 * Remplir le tableau RESOURCES avec les données des ressources IDFO.
...
// Purge existing IDFO resources before reinserting
