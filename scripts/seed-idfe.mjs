/**
 * Seed script — IDFE (Île-de-France Est)
 * Run: node --env-file-if-exists=/vercel/share/.env.project scripts/seed-idfe.mjs
 *
 * Remplir le tableau RESOURCES avec les données des ressources IDFE.
...
// Purge existing IDFE resources before reinserting
